...
\subtitle{Scius Forum Oral Presentation (OM01\_0206)}
\author[Burapat, Kawitn]{%
  Mr. Burapat Suwanprasert, Mr. Kawin Chumtong 
}
...
\begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=center] at (current page.center) {\includegraphics[page=\p,width=\paperwidth,height=\paperheight]{./source/new4:3.pdf}};
    \end{tikzpicture}
\end{frame}
}
